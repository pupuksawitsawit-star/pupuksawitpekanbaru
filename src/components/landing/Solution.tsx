...
export function Solution() {
  const solutions = [
    ...
    },
    {
      ...
      description: 'Kapasitas supply 10-100 ton per bulan untuk perkebunan skala besar'
    }
  ]
  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        {/* Bottom CTA */}
        <div className="text-center mt-12 bg-green-50 rounded-xl p-8 max-w-4xl mx-auto">
